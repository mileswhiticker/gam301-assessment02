#ifndef CEGUI_FORMATTEDLISTBOXTEXTITEM_HPP
#define CEGUI_FORMATTEDLISTBOXTEXTITEM_HPP
//this was hacked together by CrazyEddie in anticipation of a proper job being done in future releases
...
#endif	//CEGUI_FORMATTEDLISTBOXTEXTITEM_HPP